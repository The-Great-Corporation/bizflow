...
def test_ajouter_produit():
    ...
    savon = Produit(nom="Savon noir", reference="SAV001", prix_achat=2.0, prix_vente=5.0, quantite=20, seuil_alerte=5)
...
def test_enregistrer_mouvement_entree():
    ...
    entree = MouvementStock(produit=savon, type_mouvement=TypeMouvement.ENTREE, quantite=10, date=datetime.now())
...
def test_enregistrer_mouvement_sortie_insuffisante():
    gestion = GestionnaireStock()
    savon = Produit(nom="Savon noir", reference="SAV001", prix_achat=2.0, prix_vente=5.0, quantite=5, seuil_alerte=5)
    gestion.ajouter_produit(savon)

    sortie = MouvementStock(produit=savon, type_mouvement=TypeMouvement.SORTIE, quantite=100, date=datetime.now())
...
def test_produit_en_alerte():
    gestion = GestionnaireStock()
    savon = Produit(nom="Savon noir", reference="SAV001", prix_achat=2.0, prix_vente=5.0, quantite=3, seuil_alerte=5)
    shampoing = Produit(nom="Shampoing", reference="SHA001", prix_achat=3.0, prix_vente=7.0, quantite=20, seuil_alerte=5)
